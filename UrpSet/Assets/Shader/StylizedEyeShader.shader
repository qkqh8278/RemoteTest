Shader "ADA/Character/StylizedEyeShader"
{
    Properties
    {
        ...
        [Space(10)]
        [Header(Dyeing Eye)]
        _DyeingTex1("Dyeing Eye Texture  (R)", 2D) = "black" {}
        _DyeingColor1("Dyeing Color Eye ", Color) = (1,1,1,1)
        _DyeingRoughness1("Dyeing Roughness Eye", Range(0,1)) = 1
        _DyeingArea1("Dyeing Area Eye", Range(0.1,0.9)) = 0.5
        _DyeingAmount1("Dyeing Amount Eye", Range(0,1)) = 1
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            TEXTURE2D(_DyeingTex1);  SAMPLER(sampler_DyeingTex1);
            ...
            half4 frag (v2f i) : SV_Target
            {
                ...
                float4 dyeingTex1 = SAMPLE_TEXTURE2D(_DyeingTex1, sampler_DyeingTex1, i.uv);


                float dyeingTex1Alpha = smoothstep(_DyeingArea1 - 0.1, _DyeingArea1 + 0.1, dyeingTex1.r);


                albedo.rgb = lerp(albedo.rgb, BlendOverlay(albedo.rgb, _DyeingColor1.rgb), dyeingTex1Alpha * _DyeingAmount1) ;
                ...
                float dyeingSmoothness = lerp( smoothness , 1-_DyeingRoughness1, dyeingTex1Alpha * _DyeingAmount1);
