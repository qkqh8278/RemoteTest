...
Shader "ADA/Character/MakeUpSkinShader"
{
    Properties
    {
        ...
        _DYEING_ROUGHNESS_BLUSHER("Dyeing Roughness Blusher", Range(0,1)) = 1
        ...
        _DYEING_OVERLAY_BLUSHER("Dyeing Blusher Overlay To Multiply", Range(0,1)) = 0
        [Space(20)]
        [Header(Dyeing Shadow)]
        _DYEING_TEX_SHADOW("Dyeing Texture Shadow (A)", 2D) = "black" {}
        _SHADOW_COLOR("Dyeing Color Shadow ", Color) = (1,1,1,1)
        _DYEING_ROUGHNESS_SHADOW("Dyeing Roughness Shadow", Range(0,1)) = 1
        ...
        _DYEING_OVERLAY_SHADOW("Dyeing Shadow Overlay To Multiply", Range(0,1)) = 0
        [Space(20)]
        [Header(Dyeing Line)]
        _DYEING_TEX_LINE("Dyeing Texture Line (A)", 2D) = "black" {}
        _LINE_COLOR("Dyeing Color Line ", Color) = (1,1,1,1)
        _DYEING_ROUGHNESS_LINE("Dyeing Roughness Line", Range(0,1)) = 1
        ...
        _DYEING_OVERLAY_LINE("Dyeing Line Overlay To Multiply", Range(0,1)) = 0
        [Space(20)]
        [Header(Dyeing Lip)]
        _DYEING_TEX_LIP("Dyeing Texture Lip (A)", 2D) = "black" {}
        _LIP_COLOR("Dyeing Color Lip ", Color) = (1,1,1,1)
        _DYEING_ROUGHNESS_LIP("Dyeing Roughness Lip", Range(0,1)) = 1
        ...
        _DYEING_OVERLAY_LIP("Dyeing Lip Overlay To Multiply", Range(0,1)) = 0
        ...
        _DYEING_ROUGHNESS_FREKLES("Dyeing Roughness Frekles", Range(0,1)) = 1
        ...
        _DYEING_OVERLAY_FREKLES("Dyeing Frekles Overlay To Multiply", Range(0,1)) = 0

        [Space(20)]
        [Header(Dyeing Tatoo)]
        _DYEING_TEX_TATOO("Dyeing Texture Tatoo (A)", 2D) = "black" {}
        _TATOO_COLOR("Dyeing Color Tatoo ", Color) = (1,1,1,1)
        _DYEING_ROUGHNESS_TATOO("Dyeing Roughness Tatoo", Range(0,1)) = 1
        ...
        _DYEING_OVERLAY_TATOO("Dyeing Tatoo Overlay To Multiply", Range(0,1)) = 0
        ...
        _DYEING_TEX_PERL("Perl Texture (RGB) ", 2D) = "Gray" {}
        _PerlMaskTex ("Perl Mask Texture (A)", 2D) = "Black" {}
        _PerlSpecularOffset("Perl Specular Offset", Vector) = (0,0,0,0)
        _DYEING_AREA_PERL("Perl Mask Area Threshold", Range(0,1)) = 0.5
        _DYEING_SMOOTH_AREA_PERL("Perl Mask Area Smooth", Range(0,0.5)) = 0.25
        _PERL_COLOR ("Perl Color", Color) = (1,1,1,1)
        _DYEING_GLITTER_PERL ("Perl Power", Range(64,500)) = 64
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            TEXTURE2D(_DYEING_TEX_PERL);  SAMPLER(sampler_DYEING_TEX_PERL);
            ...
            float _DYEING_GLITTER_PERL, _PerlIntensity,_DYEING_AREA_PERL, _DYEING_SMOOTH_AREA_PERL;
            float4 _PERL_COLOR, _PerlSpecularOffset;
            ...
            half4 frag (v2f i) : SV_Target
            {
                ...
                float4 dyeingTex6 = SAMPLE_TEXTURE2D(_DYEING_TEX_TATOO, sampler_DYEING_TEX_TATOO, i.uv);

                float dyeingTex1Alpha = smoothstep( saturate(_DYEING_AREA_BLUSHER - _DYEING_SMOOTH_AREA_BLUSHER), _DYEING_AREA_BLUSHER + _DYEING_SMOOTH_AREA_BLUSHER, dyeingTex1.a);
                float dyeingTex2Alpha = smoothstep( saturate(_DYEING_AREA_SHADOW - _DYEING_SMOOTH_AREA_SHADOW), _DYEING_AREA_SHADOW + _DYEING_SMOOTH_AREA_SHADOW, dyeingTex2.a);
                float dyeingTex3Alpha = smoothstep( saturate(_DYEING_AREA_LINE - _DYEING_SMOOTH_AREA_LINE), _DYEING_AREA_LINE + _DYEING_SMOOTH_AREA_LINE, dyeingTex3.a);
                float dyeingTex4Alpha = smoothstep( saturate(_DYEING_AREA_LIP - _DYEING_SMOOTH_AREA_LIP), _DYEING_AREA_LIP + _DYEING_SMOOTH_AREA_LIP, dyeingTex4.a);
                float dyeingTex5Alpha = smoothstep( saturate(_DYEING_AREA_FREKLES - _DYEING_SMOOTH_AREA_FREKLES), _DYEING_AREA_FREKLES + _DYEING_SMOOTH_AREA_FREKLES, dyeingTex5.a);
                float dyeingTex6Alpha = smoothstep( saturate(_DYEING_AREA_TATOO - _DYEING_SMOOTH_AREA_TATOO), _DYEING_AREA_TATOO + _DYEING_SMOOTH_AREA_TATOO, dyeingTex6.a);

                albedo.rgb = lerp(albedo.rgb, lerp(BlendOverlay(albedo.rgb, _BLUSHER_COLOR.rgb), albedo.rgb * _BLUSHER_COLOR.rgb, _DYEING_OVERLAY_BLUSHER), dyeingTex1Alpha * _DYEING_AMOUNT_BLUSHER);
                albedo.rgb = lerp(albedo.rgb, lerp(BlendOverlay(albedo.rgb, _SHADOW_COLOR.rgb), albedo.rgb * _SHADOW_COLOR.rgb, _DYEING_OVERLAY_SHADOW), dyeingTex2Alpha * _DYEING_AMOUNT_SHADOW);
                albedo.rgb = lerp(albedo.rgb, lerp(BlendOverlay(albedo.rgb, _LINE_COLOR.rgb), albedo.rgb * _LINE_COLOR.rgb, _DYEING_OVERLAY_LINE), dyeingTex3Alpha * _DYEING_AMOUNT_LINE);
                albedo.rgb = lerp(albedo.rgb, lerp(BlendOverlay(albedo.rgb, _LIP_COLOR.rgb), albedo.rgb * _LIP_COLOR.rgb, _DYEING_OVERLAY_LIP), dyeingTex4Alpha * _DYEING_AMOUNT_LIP);
                albedo.rgb = lerp(albedo.rgb, lerp(BlendOverlay(albedo.rgb, _FREKLES_COLOR.rgb), albedo.rgb * _FREKLES_COLOR.rgb, _DYEING_OVERLAY_FREKLES), dyeingTex5Alpha * _DYEING_AMOUNT_FREKLES);
                albedo.rgb = lerp(albedo.rgb, lerp(BlendOverlay(albedo.rgb, _TATOO_COLOR.rgb), albedo.rgb * _TATOO_COLOR.rgb, _DYEING_OVERLAY_TATOO), dyeingTex6Alpha * _DYEING_AMOUNT_TATOO);
                ...
                float dyeingSmoothness = lerp(lerp(lerp(lerp(lerp(lerp( smoothness , 1-_DYEING_ROUGHNESS_BLUSHER, dyeingTex1Alpha * _DYEING_AMOUNT_BLUSHER),  1- _DYEING_ROUGHNESS_SHADOW, dyeingTex2Alpha * _DYEING_AMOUNT_SHADOW),  1- _DYEING_ROUGHNESS_LINE, dyeingTex3Alpha * _DYEING_AMOUNT_LINE),  1- _DYEING_ROUGHNESS_LIP, dyeingTex4Alpha * _DYEING_AMOUNT_LIP),  1- _DYEING_ROUGHNESS_FREKLES, dyeingTex5Alpha * _DYEING_AMOUNT_FREKLES),  1- _DYEING_ROUGHNESS_TATOO, dyeingTex6Alpha * _DYEING_AMOUNT_TATOO);
                ...
                perlMask = smoothstep ( saturate(_DYEING_AREA_PERL - _DYEING_SMOOTH_AREA_PERL), _DYEING_AREA_PERL + _DYEING_SMOOTH_AREA_PERL, perlMask);
                float3 perlNormal = SAMPLE_TEXTURE2D(_DYEING_TEX_PERL, sampler_DYEING_TEX_PERL, i.uv * _DYEING_TEX_PERL_ST.xy + _DYEING_TEX_PERL_ST.xy).xyz - 0.5;
                ...
                float3 perlColor = pow(abs(perl), max(0,_DYEING_GLITTER_PERL) + 0.001) * max(0,_PerlIntensity) * perlMask * _PERL_COLOR.rgb ;
                col.rgb += perlColor;
