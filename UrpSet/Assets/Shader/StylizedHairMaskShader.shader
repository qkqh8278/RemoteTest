Shader "ADA/Character/StylizedHairMaskShader"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert (appdata input)
            {
                ...
                output.positionCS = vertexInput.positionCS; //TransformObjectToHClip(lerp(input.vertex.xyz, float3(input.texcoord.xy,1), _UVCon) );//vertexInput.positionCS;
